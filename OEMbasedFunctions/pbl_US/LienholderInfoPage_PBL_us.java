...
public class LienholderInfoPage_PBL_us {
	public WebDriver driver;
	
	 public LienholderInfoPage_PBL_us(WebDriver driver)
		{
			this.driver=driver;
	 ...
	 {
		 try{	 		
		 		if(product.contains("MULTI-COVERAGE") || product.contains("VEHICLE SERVICE PROTECTION") || product.contains("PORSCHE TERM PROTECTION") || product.contains("PORSCHE TERM PROTECTION PLUS") || product.contains("PREPAID MAINTENANCE")){
					//|| product.contains("QUALITYSHIELD GAP PROTECTION")
