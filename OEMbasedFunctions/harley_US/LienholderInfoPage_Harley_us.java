...
public class LienholderInfoPage_Harley_us {
	public WebDriver driver;
	
	
	 public LienholderInfoPage_Harley_us(WebDriver driver)
		{
			this.driver=driver;
	 ...
	 public void lienHolder(String lien, String product) //Function for selecting an check box id NoLienholderCheckBox 
	 {
	 	...
	 	try{	 
	 		...
	 		if(product.contains("HARLEY-DAVIDSON PLANNED") || product.contains("THEFT") || product.contains("MAINTENANCE")){
