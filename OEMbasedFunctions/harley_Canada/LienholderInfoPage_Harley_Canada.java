...
public class LienholderInfoPage_Harley_Canada {
	public WebDriver driver;
	
	
	 public LienholderInfoPage_Harley_Canada(WebDriver driver)
		{
			this.driver=driver;
	 ...
	 public void lienHolder(String product, String lien) //Function for selecting an check box id NoLienholderCheckBox 
	 {
		 
		 
	 	try{	 		
	 		if(product.contains("PLANNED") || product.contains("THEFT") || product.contains("GPS THEFT")){
