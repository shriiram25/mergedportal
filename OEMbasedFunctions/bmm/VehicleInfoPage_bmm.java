...
public class VehicleInfoPage_bmm {
	
	public WebDriver driver;

	public VehicleInfoPage_bmm(WebDriver driver) {
		this.driver = driver;
	...
	public void entervehicleinfo(String product, String vehiclemsrp, String financeamount, String apr, String grossgapcost, String vehicleprice) {
        ...
        if (product.contains("CANADA BASE CPO") || product.contains("CANADA CPO") ||  product.contains("CANADA VSC") || product.contains("CANADA BASE")) { 
