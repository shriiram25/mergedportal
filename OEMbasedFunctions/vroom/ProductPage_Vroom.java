...
public class ProductPage_Vroom {

	public WebDriver driver;

	public ProductPage_Vroom(WebDriver driver) {
		this.driver = driver;
	...
	public void selectProduct1(String product, String bundleselection, String plan, String termMonth, String termmiles,
		...
		if (product.contains("VSC PROTECTION") || product.contains("VSC LIMITED WARRANTY") || product.contains("SPECIALTY PARTNER LTD WARRANTY")) {
		...
		} else if (product.contains("TIRE AND WHEEL PROTECTION") || product.contains("ROADSIDE PROTECTION")) {

			selectPlan(plan);
			selectTermMonthDropdown(termMonth);
			selectDeductibleDropdown(deductible);

		} else if (product.contains("GAP PROTECTION")) {
