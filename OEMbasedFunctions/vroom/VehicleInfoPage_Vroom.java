...
public class VehicleInfoPage_Vroom {
	
	public WebDriver driver;

	public VehicleInfoPage_Vroom(WebDriver driver) {
		this.driver = driver;
	...
	public void entervehicleinfo(String product, String vehiclemsrp, String financeamount, String apr, String grossgapcost, String vehicleprice) {
		 ...
		 if (product.contains("GAP PROTECTION")) {
		 ...
		 } else if (product.contains("VROOM VSC") || product.contains("VSC LIMITED WARRANTY") || product.contains("SPECIALTY PARTNER LTD WARRANTY")) {
		 ...
		 } else if (product.contains("VROOM EVEHICLE")) {
