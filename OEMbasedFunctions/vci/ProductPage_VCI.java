...
public class ProductPage_VCI {
	...
	public String product5 = "VSC";
	public String product3 = "THEFT";
	public String product4 = "TERM";	
	public String product6 = "PROMOTION";
	public String product7 = "EXTENSION";
	public String product8 = "QP TERM";
	
	public ProductPage_VCI(WebDriver driver) {
		this.driver = driver;
	...
	public void selectProduct1(String product, String bundleselection,String plan, String termMonth, String termmiles, String deductible){
		...
		else if(product.contains(product2) || product.contains(product4) || product.contains(product5)|| product.contains(product6)|| product.contains(product7)|| product.contains(product8)) {
				selectPlan(plan);
	...
	/*
	  Finding the registration number element 
	 */
...
public void selectRegNumber(String rNumber){
	...
	//Continue Button
	public void addContract(String plan){
		try{
			WebDriverWait wait = new WebDriverWait(driver, 20);
	...
	@FindBy(id="oow_yes")
	public WebElement oowYes;
	//Continue Button
	public void clickYesOowPopUp(){
		try{
			WebDriverWait wait = new WebDriverWait(driver, 20);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("oow_yes")));				
			oowYes.click();
		}			
		catch(Exception e){
			GetScreenshot.captureScreenshot();
