...
public class CustomerDetailsPage_VCI {
	...
	public String product7 = "THEFT";
	public String product8 = "TERM";
	...
	public CustomerDetailsPage_VCI(WebDriver driver) {
		this.driver = driver;
...
//			AUDI TERM PROTECTION -- Vehicle MSRP --- done
//			AUDI VEHICLE Service PROTECTION -- Vehicle Purchase Price -- DONE
//			AUDI MULTI COVERAGE PROTECTION -- Finance Amount , Vehicle Purchase Price --- ONLY FINANCEAMT
//			AU PP GAP PLUS PROTECTION -- Vehicle MSRP, Finance Amount,APR  --- done
//			AUDI THEFT PROTECTION -- Finance Amount, Vehicle Purchase Price --- ONLY FINANCEAMT
			
			
			/*if(product.contains(product1) || product.contains(product7) || product.contains(product6)) //Checking if the product is equal to the value stored in product1
			{
			...
			else if(product.contains(product4)  || product.contains(product9) || product.contains(product10)|| product.contains(product11)) //Checking if the product is equal to the value stored in product4
			{
