...
public class VehicleInfoPage_Fuccillo {
	...
	public String product5 = "LFuccilloE";
	...
	// Declaring variables to write excel
	 ...
	 public VehicleInfoPage_Fuccillo(WebDriver driver)
		{
			this.driver=driver;
	 ...
	 public void entervehicleinfo(String product,String vehiclemsrp, String financeamount, String apr, String grossgapcost, String vehicleprice){
		 ...
		 vehiclePrice = vehicleprice;
		  ...
		  else if(product.contains(product3) || product.contains(product1) || product.contains(product7) || product.contains(product6) || product.contains(product8)){
		  ...
		  else if(product.contains(product4)){
