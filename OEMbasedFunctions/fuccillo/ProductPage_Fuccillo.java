...
public class ProductPage_Fuccillo {
	...
	public String product2 = "PREPAID MAINTENANCE";
	public String product3 = "THEFT";
	public String product4 = "TERM";
	
	public ProductPage_Fuccillo(WebDriver driver) {
		this.driver = driver;
		...
		if(product.contains(product1))
 		{
			if(bundleselection.equalsIgnoreCase(product1sub)){	 			
			    ...
			    {
			    	//FuccilloHooks.log.debug(temp[i]);
	...
	/*public void  writeExcel(){
		...
		try{			
			...
			valueToWriteNew = new String[10];
			valueToWriteNew[0]= productSeleted;
			valueToWriteNew[1]= bundleSelection;
			valueToWriteNew[2]= plan_product;
			valueToWriteNew[3]= termmonth;
			valueToWriteNew[4]= termMiles;
			valueToWriteNew[5]= de_ductible;
			valueToWriteNew[6]= retailPrice; 		
			valueToWriteNew[7]= ErrorMessage.ErrorMessage;
			valueToWriteNew[8]= GetScreenshot.filename;		
 		
			
			Hooks.FuccilloContractSteps.valueToWriteinResult[4]= productSeleted;
			CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[5]= plan_product;
			CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[7]= termmonth;
			CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[8]= termMiles;
			CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[10]= de_ductible;
			CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[11]= dlrcost;
			CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[12]= actcost;
			
			if(dlrcost.equals(actcost)){
				CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[13]= "PASS";
			}
			else{
				CucumberFuccilloAutomation.FuccilloContractSteps.valueToWriteinResult[13]= "FAIL";
			}
